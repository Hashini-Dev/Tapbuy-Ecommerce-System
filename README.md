...
Built using **Java Servlets + Hibernate ORM**, following the **MVC architecture**, and deployed using **GlassFish Server**.
...
This project follows **MVC (Model-View-Controller)** design pattern:
